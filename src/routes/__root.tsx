...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discovery is the Journey, Insight is the Destination. Trusted overseas job consultancy offering career guidance, interview preparation, and global placement." },
